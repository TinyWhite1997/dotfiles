...
local key_tables = {
  ...
  copy_mode = {
    ...
    { "H",       act.CopyMode "MoveToStartOfLine",                      "line start" },
    { "L",       act.CopyMode "MoveToEndOfLineContent",                 "line end" },
    { "d",       act.CopyMode { MoveByPage = 1 },                       "down page" },
    { "u",       act.CopyMode { MoveByPage = -1 },                      "up page" },
